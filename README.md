...
| 主题 | 内容 | 入口 |
|---|---|---|
| Go 语言主干 | 模块与类型、数据容器、错误、接口与断言、泛型、反射、并发、测试与最小项目闭环 | [Go 语言简明教程](go_note/Go语言简明教程.md) |
| Go 后端基本功 | 网络与 HTTP、业务 API、Go 测试、Linux、Git | [总目录与最小闭环](Go后端基本功/README.md) |
| Go 高性能编程 | 性能分析、性能实验、内存局部性、并发资源治理、编译器优化 | [总目录与最小闭环](go_note/Go语言高性能编程/Go语言高性能编程-总目录与最小闭环.md) |
| Go 面试复习主干 | 语言基础、值模型、数据容器、接口、并发、context、调度器、GC 与 unsafe | [统一入口](go_note/Go语言笔试面试题/00-总目录与学习路线.md) |
...
2. 用 [Go 面试主干复习](go_note/Go语言笔试面试题/00-总目录与学习路线.md) 把语言、运行时和并发知识串成可主动回忆的骨架。
