...
这是一个面向长期积累的工程学习仓库，当前以 Go、数据结构与算法笔记为主，后续逐步扩展到：

> Go 后端 + TypeScript/React 前端 + LLM/Agent 工程 + AI 辅助开发与验证

这里不追求把资料堆满，而是把知识整理成可以解释、实现、测试、复盘和迁移的最小闭环。每个主题优先回答五个问题：
...
最终目标不是分别学会四堆工具，而是完成一个能运行、能解释、能测试、能观测、能持续演进的全栈项目。
...
未来内容会在真正开始积累后再增加对应目录，暂不创建空目录：

```text
notes/typescript-react/
notes/llm-agent/
notes/ai-assisted-development/
projects/
verification/
```
